<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $asunto="Registro de cuenta en DUTIC";
        $cabecera="From: DUTIC<dutic@unsa.edu.pe>";
        $mensaje_mail="Hola ".$nombre_reg.", Gracias por registrarte en DUTIC. Los datos de cuenta son los siguientes:\nNombre Completo: ".$nombre_reg."\nNombre de usuario: ".$user_reg."\nClave: ".$clave_reg2."\nEmail: ".$email_reg."\n Página principal: http://www.unsa.dutic.edu.pe";
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4 text-center hidden-xs">
      <img src="img/dutic.jpg" class="img-responsive" alt="Image">
