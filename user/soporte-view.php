<div class="container">
  <div class="row well">
    ...
    <div class="col-sm-9 lead">
      <h2 class="text-info">Bienvenido al centro de soporte de DUTIC</h2>
    ...
    <div class="col-sm-6">
      <div class="panel panel-info">
        ...
        <div class="panel-body text-center">
          ...
          <p class="text-justify">Si tienes un problema con el uso del aula virtual, reportalo creando un nuevo ticket y te ayudaremos a solucionarlo.Si desea actualizar una peticion ya realizada utiliza el formulario de la derecha <em>Comprobar estado de Ticket</em>, solamente los <strong>usuarios registrados</strong> pueden abrir un nuevo ticket.</p>
