                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <select class="form-control" name="departamento_ticket">
                                  <option value="Ventas">Ing. de sistemas</option>
                                  <option value="Software">Ing. de agronomia</option>
                                  <option value="Hardware">Fisica I</option>
                                </select>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7 text-center">
                <h1 class="text-danger">Lo sentimos esta página es solamente para usuarios registrados en DUTIC - UNSA</h1>
